...
{ 
    ...
    {
        $id=intval($_GET['rid']);
        $query=mysqli_query($con,"update tblproducts set Is_Active='0' where id='$id'");
        $msg="Product deleted ";
    }
    // Code for restore
    if($_GET['resid'])
    {
        ...
        $query=mysqli_query($con,"update tblproducts set Is_Active='1' where id='$id'");
...
<html lang="en">
    <head>
        ...
        <title>Newsportal | Manage Products</title>
...
<tbody>
    <?php
                        ...
                        <td><a href="edit-product.php?cid=<?php echo htmlentities($row['id']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
                            &nbsp;<a href="manage-products.php?cid=<?php echo htmlentities($row['id']);?>&&action=del" onclick="return confirm('Do you reaaly want to delete ?')"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
                        </tr>
                        <?php } }?>                               
                    </tbody>
                </table>
